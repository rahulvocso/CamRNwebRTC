...
import {View, Text, Section, TouchableOpacity, StyleSheet} from 'react-native';
import {
  RTCView,
  MediaStream,
  mediaDevices,
    ...
    //
      ...
      try {
        ...
        await notifee.displayNotification({
          ...
          body: 'This notification will be here until you stop capturing, **ERR**:',
          android: {
            channelId,
        ...
        // Handle Error
        console('Inside toggleRecording to record screen ', err);
      }
      setRecording(true);
    }
  };

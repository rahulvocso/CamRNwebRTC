...
const CameraStream = () => {
  ...
  const handleCameraOnOff = () => {
    isCameraOn ? setIsCameraOn(false) : setCameraFacing('user');
  };

  const handleMicrophoneOnOff = () => {
    isMicrophoneOn ? setCameraFacing('environment') : setCameraFacing('user');
  };
    ...
    <View style={styles.container}>
      {!streaming ? (
        ...
        <>
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={handleMicrophoneOnOff}>
            <Text style={styles.buttonText}>Microphone On/Off</Text>
          </TouchableOpacity>
          // Stop Camera Stream
